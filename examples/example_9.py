#!/usr/bin/env python3
"""UMA Hessian comparison example for rotated equilibrium water (standalone).

This example is based on example_7 (equilibrium water) but with a small random
3D rotation applied to the coordinates. This tests whether the regression observed
in example_7 is orientation-dependent or geometry-dependent.
