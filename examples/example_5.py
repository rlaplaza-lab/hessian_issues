#!/usr/bin/env python3
"""UMA Hessian comparison example (standalone) - Transition state structure.

This example tests a transition state structure (A_C_A_B_A_C_ts) to validate
Hessian computation on more complex molecular systems.
