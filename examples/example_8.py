#!/usr/bin/env python3
"""UMA Hessian comparison example (standalone) - Rotated distorted methane test case.

This example is based on example_3 (distorted methane) but with a small random
3D rotation applied to the coordinates. This tests whether the regression observed
in example_3 is orientation-dependent or geometry-dependent.
